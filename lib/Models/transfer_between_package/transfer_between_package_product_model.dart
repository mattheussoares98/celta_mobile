import './transfer_between_package_all_stocks_model.dart';

class TransferBetweenPackageProductModel {
  ...
  final List<TransferBetweenPackageAllStocksModel> Stocks;
  ...
  static dataToTransferBetweenPackageProductModel({
    required Map data,
  ...
  static Map<String, List<TransferBetweenPackageAllStocksModel>> _stocks = {};
